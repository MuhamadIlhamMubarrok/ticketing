...
const PackageSelection = () => {
  ...
  return (
    ...
    <div className="py-10 px-4 min-h-scree relative overflow-hidden">
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <h1 className="text-4xl md:text-6xl font-extrabold mb-4 font-heading text-gray-900">
            Setia <span className="text-primary">Bersamamu</span>
          </h1>
          <p className="text-xl text-gray-500 font-body font-light italic">"Merawat Cinta Sampai Surga"</p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {packages.map((pkg) => (
            ...
            >
              ...
              {pkg.isPopular && <div className="absolute -inset-1 bg-gradient-to-r from-yellow-400 to-amber-300 rounded-[2rem] blur opacity-25 group-hover:opacity-50 transition duration-200"></div>}
              ...
              <div className="relative bg-white rounded-3xl overflow-hidden shadow-xl border border-gray-100 flex flex-col h-full hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1">
                ...
                <div className={`p-8 bg-gradient-to-br ${pkg.theme} font-body text-white relative`}>
                  <div className="relative z-10 flex justify-between items-start">
                    ...
                    <div className="p-3 bg-white/10 backdrop-blur-md rounded-xl border border-white/20 shadow-inner">{pkg.icon}</div>
                  </div>
                ...
                <div className="p-8 flex-1 flex flex-col font-body bg-white">
                  ...
                  <button
                    ...
                    className={`font-body w-full py-4 rounded-xl font-bold text-sm uppercase tracking-wide shadow-md transition-all duration-300 ${pkg.buttonColor} hover:shadow-lg hover:brightness-110`}
                  >
                    Pilih Paket Ini
                  </button>
                </div>
