      ...
      <div className="bg-white max-w-6xl w-full rounded-3xl shadow-2xl overflow-hidden flex flex-col md:flex-row min-h-[600px]">
        ...
        <div className="w-full md:w-3/5 p-8 md:p-12 flex flex-col justify-center order-2 md:order-1">
          ...
          <div className=" mb-8">
            ...
            <h1 className="text-3xl text-center md:text-4xl font-heading font-bold text-secondary mb-2">Lengkapi Data Diri</h1>
            <p className="text-gray-500 text-center text-sm">Isi form di bawah untuk mengamankan tiketmu.</p>
          </div>

          {/* Stepper Custom */}
          <div className="flex items-center gap-1 mb-8 bg-[#f5f3ee] p-1 rounded-full w-full border border-gray-200">
            {/* Active Step: bg-gold (Primary) */}
            <div className="px-6 py-2 bg-gold text-white font-bold rounded-full w-[50%] text-center text-sm shadow-md transition-all">Data Diri</div>
            <div className="px-6 py-2 w-[50%] text-center text-gray-400 font-medium text-sm">Konfirmasi</div>
          </div>
            ...
            <div className="bg-[#f5f3ee] border border-gray-200 rounded-xl p-4 mt-4">
              <label className="flex items-start gap-3 cursor-pointer">
                ...
                <div className="text-sm">
                  ...
                  <p className="text-gray-500 text-xs mt-1">Bukti transfer (screenshot) wajib dikirimkan manual ke WhatsApp Admin setelah tombol kirim ditekan.</p>
                </div>
              </label>
            </div>
        ...
        <div className="w-full md:w-2/5 p-8 md:p-12 text-light flex flex-col justify-between relative overflow-hidden order-1 md:order-2 bg-dark">
          ...
          <div>
            ...
            <p className="opacity-80 text-sm font-light leading-relaxed">"Selesaikan langkah ini untuk memulai perjalanan merawat cinta sampai surga."</p>
          </div>
          ...
          <div className="mt-8 bg-white text-secondary rounded-2xl p-6 shadow-2xl relative z-10 border border-gray-100">
            ...
            <div className="text-center">
              ...
              <div className="rounded-xl overflow-hidden border-2 border-dashed border-gray-200 p-2 bg-[#f5f3ee]">
                <img src={qs} alt="QRIS" className="w-full h-auto object-cover rounded-lg mix-blend-multiply" />
              </div>
